...
class GaussianModelLoader:
    ...
    def initialize_model_from_checkpoint(cls, checkpoint: dict, device):
        ...
        model_state_dict["gaussians.scales"]=model_state_dict["gaussians.scales"][mask]
        model_state_dict["gaussians.means"]=model_state_dict["gaussians.means"][mask]
        model_state_dict["gaussians.shs_dc"]=model_state_dict["gaussians.shs_dc"][mask]
        model_state_dict["gaussians.shs_rest"]=model_state_dict["gaussians.shs_rest"][mask]
        model_state_dict["gaussians.opacities"]=model_state_dict["gaussians.opacities"][mask]
        model_state_dict["gaussians.rotations"]=model_state_dict["gaussians.rotations"][mask]
